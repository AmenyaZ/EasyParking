package com.example.smartparking.VehicleProfile;
...
public class VehicleProf extends AppCompatActivity {
    ...
    com.example.smartparking.model.VehicleModel worker ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_prof);
