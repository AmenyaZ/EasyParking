...
//
//import com.example.smartparking.Adapter.VehicleAdapter;
...
//    Adapter.VehicleAdapter adapter;
//    LinearLayoutManager layoutManager;
//    List<VehicleModel> WorkerList;
//    List<VehicleModel> filteredProductsList;
//    EditText searchText;
...
//                } else {
//                    adapter = new Adapter.VehicleAdapter(Display.this, WorkerList);
...
//                        VehicleModel model = postSnapshot.getValue(VehicleModel.class);
...
//
//                    Toast.makeText(Display.this, "Permission Denied...", Toast.LENGTH_SHORT).show();
...
//                    VehicleModel modelFiltered = snapshot.getValue(VehicleModel.class);
//
//                    if (pName.equals(null)) {
//                        Toast.makeText(Display.this, "Name is null", Toast.LENGTH_SHORT).show();
//                    } else {
...
//                            Toast.makeText(Display.this, "Specialization is Null", Toast.LENGTH_SHORT).show();
//                        } else {
...
//                                Toast.makeText(Display.this, "Location is null", Toast.LENGTH_SHORT).show();
//                            } else {
...
//                    adapter = new VehicleAdapter(Display.this, filteredProductsList);
//                    recyclerView.setAdapter(adapter);
//                } else {
//                    defaultView.setVisibility(View.VISIBLE);
