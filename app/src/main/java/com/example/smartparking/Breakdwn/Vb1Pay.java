...
public class Vb1Pay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vb1_pay);
        ...
        Daraja1 = Daraja.with("waoFzKgJGq0ZTfS0LLm7yIloiXqBnqoh", "EFUU9AtK4rjBn9nb", new DarajaListener<AccessToken>() {
            ...
            public void onError(String error) {
                ...
                Toast.makeText(Vb1Pay.this, "Error " + error, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Daraja1.requestMPESAExpress(lnmExpress,
                new DarajaListener<LNMResult>() {
                    ...
                    public void onResult(@NonNull LNMResult lnmResult) {
                        Log.i(Vb1Pay.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
                    ...
                    @Override
                    public void onError(String error) {
                        Log.i(Vb1Pay.this.getClass().getSimpleName(), error);
                        genericLoader.dismiss();
                    }
                }
        );
