...
public class BusPay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Daraja1 = Daraja.with("waoFzKgJGq0ZTfS0LLm7yIloiXqBnqoh", "EFUU9AtK4rjBn9nb", new DarajaListener<AccessToken>() {
            ...
            public void onError(String error) {
                ...
                Toast.makeText(BusPay.this, "Error " + error, Toast.LENGTH_SHORT).show();
            }
        });
...
//                        Log.i(MatatuPay.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
...
//                    @Override
//                    public void onError(String error) {
//                        Log.i(MatatuPay.this.getClass().getSimpleName(), error);
//                        mPesaResult = "Error : " + error;
//                        genericLoader.dismiss();
//                    }
//                }
//        );
//        PayBtn.setOnClickListener(v -> Daraja1.requestMPESAExpress(lnmExpress,
//                new DarajaListener<LNMResult>() {
//                    @Override
//                    public void onResult(@NonNull LNMResult lnmResult) {
//                        Log.i(MatatuPay.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
...
//        ));
        ...
        Daraja1.requestMPESAExpress(lnmExpress,
                new DarajaListener<LNMResult>() {
                    @Override
                    public void onResult(@NonNull LNMResult lnmResult) {
                        Log.i(BusPay.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
                        mPesaResult = "Success " + lnmResult.ResponseDescription;
                        genericLoader.dismiss();
                    }
                    ...
                    @Override
                    public void onError(String error) {
                        Log.i(BusPay.this.getClass().getSimpleName(), error);
                        genericLoader.dismiss();
                    }
                }
        );
