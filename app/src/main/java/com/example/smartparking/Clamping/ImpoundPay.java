...
public class ImpoundPay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_impound_pay);
        ...
        Daraja1 = Daraja.with("waoFzKgJGq0ZTfS0LLm7yIloiXqBnqoh", "EFUU9AtK4rjBn9nb", new DarajaListener<AccessToken>() {
            ...
            public void onError(String error) {
                ...
                Toast.makeText(ImpoundPay.this, "Error " + error, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Daraja1.requestMPESAExpress(lnmExpress,
                new DarajaListener<LNMResult>() {
                    ...
                    public void onResult(@NonNull LNMResult lnmResult) {
                        Log.i(ImpoundPay.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
                    ...
                    @Override
                    public void onError(String error) {
                        Log.i(ImpoundPay.this.getClass().getSimpleName(), error);
                        genericLoader.dismiss();
                    }
                }
        );
