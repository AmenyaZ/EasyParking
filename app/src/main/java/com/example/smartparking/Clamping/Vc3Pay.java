...
public class Vc3Pay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vc3_pay);
        ...
        Daraja1 = Daraja.with("waoFzKgJGq0ZTfS0LLm7yIloiXqBnqoh", "EFUU9AtK4rjBn9nb", new DarajaListener<AccessToken>() {
            ...
            public void onError(String error) {
                ...
                Toast.makeText(Vc3Pay.this, "Error " + error, Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Daraja1.requestMPESAExpress(lnmExpress,
                new DarajaListener<LNMResult>() {
                    ...
                    public void onResult(@NonNull LNMResult lnmResult) {
                        Log.i(Vc3Pay.this.getClass().getSimpleName(), lnmResult.ResponseDescription);
                    ...
                    @Override
                    public void onError(String error) {
                        Log.i(Vc3Pay.this.getClass().getSimpleName(), error);
                        genericLoader.dismiss();
                    }
                }
        );
